            ...
            <tbody>
                @forelse ($eventos as $evento)
                    <tr>
                        ...
                        <td><span class="pill {{ $evento->type_tone }}">{{ $evento->type_label }}</span></td>
                        ...
                        <td><span class="pill {{ $evento->status_tone }}">{{ \App\Support\FarmFormat::statusLabel($evento->status) }}</span></td>
                        <td>
