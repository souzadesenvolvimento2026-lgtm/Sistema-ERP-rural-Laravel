...
rollback() {
    ...
    echo "Deploy interrompido (codigo $status)." >&2
...
require_path "$APP_DIR/public/uploads" "public/uploads do destino"
...
require_path "$RELEASE/composer.json" "composer.json"
require_path "$RELEASE/package.json" "package.json"
...
APP_KEY="${APP_KEY:-base64:AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=}" php artisan route:list >/dev/null
